...
module InstructionFetchUnit(Instruction, PCResult, PCAddResult, Branch, BranchAddress, Reset, Clk);
    ...
    wire [31:0] BranchMuxOut; // Output by ProgramCounter and input to PCAdder and InstructionMemory
